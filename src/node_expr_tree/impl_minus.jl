module minus_operators
    ...
    @inline function _evaluate_node!(op :: minus_operator, vec_value_ch :: Vector{Vector{abstract_expr_node.myRef{T}}}, vec_ref :: Vector{abstract_expr_node.myRef{T}} ) where T <: Number
