...
is_treated(c) = convexity_detection.is_treated(c)
is_not_treated(c) = convexity_detection.is_not_treated(c)
is_constant(c) = convexity_detection.is_constant(c)
is_linear(c) = convexity_detection.is_linear(c)
is_convex(c) = convexity_detection.is_convex(c)
is_concave(c) = convexity_detection.is_concave(c)
is_unknown(c) = convexity_detection.is_unknown(c)
