module implementation_type_expr
  ...
  import ..interface_type_expr: _is_constant, _is_linear, _is_quadratic, _is_more, _is_cubic, _type_product, _type_power

  export t_type_expr_basic, _is_constant, _is_linear, _is_quadratic, _is_more_than_quadratic, _is_cubic, return_constant, return_linear, return_quadratic, return_cubic, return_more
